...
function* binarySearch(arr: number[], target: number): Generator<AlgorithmStep> {
...
function getGenerator(id: AlgorithmId, data: number[], target?: number): Generator<AlgorithmStep> {
  switch (id) {
    case 'bubble-sort':
