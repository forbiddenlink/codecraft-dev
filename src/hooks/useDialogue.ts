...
import type { DialogueChoice, DialogueNode, DialogueTree } from '@/utils/dialogueSystem'
...
export function useDialogue(): UseDialogueReturn {
  ...
  const makeChoice = useCallback(
    (choiceId: string) => {
      ...
      const nextNode = dialogueSystem.advanceDialogue(currentTree.id, currentNode.id, choiceId)
