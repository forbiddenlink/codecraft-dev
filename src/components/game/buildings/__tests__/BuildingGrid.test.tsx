...
describe('BuildingGrid', () => {
  describe('visibility', () => {
    ...
    it('renders lines when showGridLines is true', () => {
      render(<BuildingGrid width={100} height={100} cellSize={10} showGridLines={true} />)
  ...
  describe('grid calculation', () => {
    ...
    it('renders fewer lines with larger cell size', () => {
      ...
      // Total: 12 lines
      render(<BuildingGrid width={100} height={100} cellSize={20} showGridLines={true} />)
      const lines = screen.getAllByTestId('line')
    ...
    it('handles asymmetric dimensions', () => {
      ...
      // Total: 8 lines
      render(<BuildingGrid width={200} height={100} cellSize={50} showGridLines={true} />)
      const lines = screen.getAllByTestId('line')
  ...
  describe('line properties', () => {
    it('uses correct color', () => {
      render(<BuildingGrid width={20} height={20} cellSize={10} showGridLines={true} />)
      const lines = screen.getAllByTestId('line')
