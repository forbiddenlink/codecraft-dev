  ...
  return (
    <group position={position} ref={visualizationRef}>
      ...
      <group visible={errors.length > 0}>
        {/* Error particles */}
        <Sparkles count={errors.length * 10} scale={[3, 3, 3]} size={1.5} speed={0.3} color="red" />

        <pointLight color="red" intensity={1.5} distance={10} />
        ...
        <Html position={[0, 0, 0]} center>
          <div className="bg-red-900 bg-opacity-80 p-3 rounded-lg text-white text-center">
            ...
            <div className="mt-2 text-sm">Check the editor for details</div>
          </div>
        </Html>
      </group>
