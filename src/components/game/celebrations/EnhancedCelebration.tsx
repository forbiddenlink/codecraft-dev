      ...
      {isVisible && (
        ...
        >
          ...
          >
            {/* Glow effect */}
            <div
              className={`absolute inset-0 bg-gradient-to-r ${getCelebrationColor()} blur-3xl opacity-50 rounded-3xl`}
            />
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="relative p-8 text-center">
                ...
                {icon && (
                  ...
                  >
                    <div
                      className={`w-24 h-24 rounded-full bg-gradient-to-r ${getCelebrationColor()} flex items-center justify-center text-white text-5xl shadow-lg`}
                    >
                      {icon}
                    </div>
                  </motion.div>
