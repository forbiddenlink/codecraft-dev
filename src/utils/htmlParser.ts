 ...
 */
export const validateStructure = (structure: GameStructureNode[], template: string): boolean => {
  const templateStructure = parseHtmlToStructure(template)

  const compareNodes = (actual: GameStructureNode[], expected: GameStructureNode[]): boolean => {
