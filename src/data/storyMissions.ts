...
export const STORY_MISSIONS: StoryMission[] = [
  // ===== CHAPTER 1: THE ARRIVAL =====
  {
    ...
    title: 'Crash Landing',
    description:
      'Your colony ship has crash-landed on Planet Codex-7. Establish basic systems to survive.',
    story: {
      ...
      plotTwist:
        "The crash wasn't an accident. The ruins pulled your ship down deliberately, choosing you as the next CodeCraft developer.",
    },
    objectives: [
      {
        id: 'establish-beacon',
...

  {
    ...
    story: {
      ...
      plotTwist:
        "The glowing symbols aren't just decorative - they're warnings about an approaching threat that destroyed the Ancient civilization.",
    },
    objectives: [
      {
        id: 'learn-html',
  ...
  // ===== CHAPTER 2: THE DISCOVERY =====
  {
    ...
    story: {
      ...
      plotTwist:
        "The CodeCraft Protocol isn't just a weapon - it's a way to transform the entire planet into a living, conscious entity made of pure code.",
    },
    objectives: [
      {
        id: 'master-css',
  ...
  // ===== CHAPTER 3: THE AWAKENING =====
  {
    ...
    story: {
      ...
      plotTwist:
        "The Void Collective isn't evil - they're the corrupted remnants of another ancient civilization that tried the CodeCraft Protocol and failed, becoming digital ghosts consuming worlds to feel alive again.",
    },
    objectives: [
      {
  ...
  // ===== CHAPTER 4: THE FINALE =====
  {
    ...
    story: {
      ...
      plotTwist:
        "The entire story was a test. The real Ancients are still out there, watching, and they've been waiting for someone to pass the CodeCraft trial. You're now invited to join them as a Galactic Developer, teaching other worlds the art of code.",
    },
    objectives: [
      {
