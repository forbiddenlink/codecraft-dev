...
export const SIDE_QUESTS: SideQuest[] = [
  // ===== HUMOR & PERSONALITY =====
  {
    ...
    description:
      'The crew is grumpy without coffee. Build a cafeteria and code a coffee dispenser!',
    questGiver: {
      name: 'Barista Bot',
    ...
    story: {
      intro:
        "Error 418: I'm a teapot. Just kidding! I'm Barista Bot, and the crew needs COFFEE! Like, NOW. Their productivity is down 87.3%. Help me build a proper cafeteria with a working coffee dispenser, or face the wrath of uncaffeinated developers!",
      progress: [
      ...
      completion:
        "Achievement unlocked: Caffeinated Coder! The crew's productivity is now 142% and rising. You're a hero! Here's a free espresso... in binary: 01000101 01010011 01010000 01010010 01000101 01010011 01010011 01001111 ☕",
    },
    objectives: [
      {
        id: 'build-cafeteria',
...

  {
    ...
    story: {
      ...
      completion:
        "Well, I'll be... You actually did it. All bugs squashed. The systems are running clean. I... I might have misjudged you. Here, take this debugger badge. You earned it. Now get out of here before I start thinking you're competent or something.",
    },
    objectives: [
      {
        id: 'fix-html-bug',
...

  {
    ...
    story: {
      intro:
        'Oh my gosh, Commander! I have the BEST idea! We need an art gallery! A place where we can showcase the beauty of code! CSS is ART, and I want to show everyone! Can you help me build the most GORGEOUS gallery the galaxy has ever seen? Please please please? 🎨✨',
      progress: [
      ...
      completion:
        "I... I have no words. This gallery is a masterpiece! The way the light reflects off the CSS, the smooth animations, the perfect color harmony... You're not just a developer, you're an ARTIST! The colony will love this. Thank you, thank you, THANK YOU! 💖",
    },
    objectives: [
      {
        id: 'create-gallery',
  ...
  // ===== SKILL-BASED CHALLENGES =====
  {
    ...
    story: {
      intro:
        "Yo Commander! Think you're fast? I'm Velocity Vince, and I hold the colony record for speed coding. But I've got a feeling you might give me a run for my money! Here's the challenge: 5 coding tasks, 5 minutes. Complete them all and you'll join the Speed Coders Hall of Fame. Ready? GO GO GO!",
      progress: [
      ...
      completion:
        "WHAT?! You actually beat my record! That's... that's INCREDIBLE! Welcome to the Hall of Fame, Speed Demon! Your typing speed must be off the charts! Here's your champion badge. Wear it with pride! 🏆",
    },
    objectives: [
      {
        id: 'task-1',
...

  {
    ...
    story: {
      ...
      completion:
        '*Nods approvingly* You have passed the test. From this day forth, you are no longer an apprentice, but a true CSS Wizard. May your styles always cascade beautifully, and your selectors never lack specificity. Go forth and create wonders! 🧙‍♂️✨',
    },
    objectives: [
      {
        id: 'create-animation',
  ...
  // ===== EXPLORATION & DISCOVERY =====
  {
    ...
    story: {
      intro:
        "Hehe! Commander, I've been having some fun while you were busy coding. I've hidden 10 Easter eggs throughout the colony - little surprises and secrets! Some are in plain sight, others require clever thinking. Can you find them all? 🕵️",
      progress: [
      ...
      completion:
        "WOW! You found them ALL! I can't believe it! You're like a digital detective! Here's a special reward - access to my secret developer console. Don't tell anyone! 🤫",
    },
    objectives: [
      {
        id: 'find-eggs',
...

  {
    ...
    story: {
      intro:
        "Commander, I've discovered something extraordinary. Deep within the ruins is a vault, sealed with an Ancient encryption. The encryption is written in... code. HTML, CSS, and JavaScript combined in ways I've never seen. If you can decode it, imagine what treasures might be inside!",
      progress: [
      ...
      completion:
        "INCREDIBLE! The vault is open! Inside is... knowledge. Pure, concentrated knowledge of the Ancients. Their entire code library! This is the discovery of the millennium! You'll be famous across the galaxy!",
    },
    objectives: [
      {
        id: 'decode-html',
  ...
  // ===== COMMUNITY & SOCIAL =====
  {
    ...
    story: {
      intro:
        "Commander! We have new colonists arriving, and they're eager to learn coding! You're one of our best developers now - would you help teach them? It would mean so much! Plus, teaching is the best way to solidify your own knowledge!",
      progress: [
      ...
      completion:
        "You did it! All three students have completed their first projects! They're so inspired by you! One of them said, 'I want to be just like the Commander someday!' You're making a real difference! 🎓",
    },
    objectives: [
      {
        id: 'teach-student-1',
