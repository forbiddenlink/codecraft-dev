import type { BuildingModelType } from '@/components/game/buildings/BuildingModel'
...
export const buildingTemplates: Record<string, BuildingTemplate> = {
  'habitat-module': {
    ...
    effects: [{ type: 'capacity', target: 'colonists', value: 10 }],
    gridSize: {
      width: 2.5,
      height: 2,
      depth: 2.5,
  ...
  'laboratory-module': {
    ...
    effects: [{ type: 'resource', target: 'research', value: 5 }],
    gridSize: {
      width: 2,
      height: 2,
      depth: 2,
  ...
  'energy-generator': {
    ...
    defaultHtml:
      '<generator class="energy-generator">\n  <div class="generator-core">Generator Core</div>\n  <footer class="generator-base">Power Systems</footer>\n</generator>',
    defaultCss:
      '.energy-generator {\n  width: 80%;\n  height: 70px;\n  background-color: #4a5568;\n  border-radius: 5px;\n  --energy-level: 100;\n}\n\n.generator-core {\n  height: 50px;\n  background-color: #fbbf24;\n  text-align: center;\n  animation: pulse 2s infinite;\n}\n\n.generator-base {\n  height: 20px;\n  background-color: #374151;\n  text-align: center;\n}\n\n@keyframes pulse {\n  0% { opacity: 0.7; }\n  50% { opacity: 1; }\n  100% { opacity: 0.7; }\n}',
    costs: [{ resourceId: 'minerals', amount: 200 }],
    effects: [{ type: 'resource', target: 'energy', value: 10 }],
    gridSize: {
      width: 1.5,
      height: 2,
      depth: 1.5,
  ...
  'nav-corridor': {
    ...
    costs: [{ resourceId: 'minerals', amount: 50 }],
    effects: [{ type: 'efficiency', target: 'colonists', value: 0.1 }],
    gridSize: {
      width: 3,
      height: 1,
      depth: 1,
