...
<!-- Add your section here -->`,
  ...
  // HTML Basics - More Structure Challenges
  {
    ...
    rewards: [{ type: 'resource', id: 'energy', amount: 25 }],
    objectives: [
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'minerals', amount: 30 }],
    objectives: [
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'research', amount: 40 }],
    objectives: [
      'Add an <img> element',
  ...
  },
  {
    ...
    requiredChallenges: ['intro-2'],
    htmlTemplate:
      '<p>Your colony has <!-- use span for emphasis -->important resources<!-- -->.</p>',
    ...
    rewards: [{ type: 'resource', id: 'energy', amount: 20 }],
    objectives: [
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'research', amount: 35 }],
    objectives: [
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'oxygen', amount: 40 }],
    objectives: [
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'energy', amount: 35 }],
    objectives: [
  ...
  },
  {
    ...
    validate: (code: string) => {
      const hasJustifyContent =
        /justify-content:\s*(space-between|space-around|space-evenly)/i.test(code)
  ...
  },
  {
    ...
    rewards: [{ type: 'resource', id: 'research', amount: 45 }],
    objectives: [
