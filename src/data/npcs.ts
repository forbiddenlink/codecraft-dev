...
export const NPCS: NPC[] = [
  // ===== CORE CREW =====
  {
    ...
    personality: 'wise',
    backstory:
      "Once known as Codex, the First Developer of the Ancient civilization. Uploaded their consciousness millennia ago to guide future generations. Carries the weight of their civilization's mistakes and hopes to help you avoid them.",
    appearance: {
      avatar: '🤖',
      color: '#3b82f6',
    },
...

  {
    ...
    personality: 'serious',
    backstory:
      'Veteran space explorer with 20 years of experience. Led the colony ship through impossible odds. Skeptical of Ancient technology but trusts your judgment. Has a secret soft spot for terrible dad jokes.',
    appearance: {
      avatar: '👩‍✈️',
      color: '#1e293b',
    },
...

  {
    ...
    backstory:
      'Brilliant scientist who dedicated their life to studying ancient civilizations. Sees the ruins as the discovery of a lifetime. Gets so excited about findings that they forget to eat or sleep. Has a collection of 47 different coffee mugs.',
    appearance: {
      avatar: '👨‍🔬',
      color: '#10b981',
    },
...

  {
    ...
    personality: 'grumpy',
    backstory:
      'Has been debugging code for 30 years. Has seen every bug imaginable. Grumpy exterior hides a caring mentor who genuinely wants you to succeed. Once debugged a quantum computer with a toothpick and determination.',
    appearance: {
      avatar: '👨‍💻',
      color: '#ef4444',
    },
...

  {
    ...
    personality: 'enthusiastic',
    backstory:
      'Believes code is art and art is code. Can spend hours perfecting a single gradient. Her designs have won 12 Galactic Design Awards. Has a pet holographic butterfly named Pixel Jr.',
    appearance: {
      avatar: '👩‍🎨',
      color: '#8b5cf6',
    },
...

  {
    ...
    backstory:
      'Holds 47 speed coding records. Types at 180 WPM. Drinks 12 cups of coffee daily. Claims he learned to code in his sleep. Actually did learn to code in his sleep (lucid dreaming).',
    appearance: {
      avatar: '⚡',
      color: '#fbbf24',
    },
...

  {
    ...
    backstory:
      'Nobody knows their real name. Speaks in riddles. Solved the Galactic Enigma at age 12. Wears a cloak even in zero gravity. Possibly a time traveler. Definitely knows more than they let on.',
    appearance: {
      avatar: '🔐',
      color: '#6366f1',
    },
...

  {
    ...
    personality: 'enthusiastic',
    backstory:
      'Former university professor who joined the colony mission to spread knowledge across the stars. Patient, kind, and genuinely loves seeing students succeed. Has taught over 10,000 students. Remembers every single one.',
    appearance: {
      avatar: '👩‍🏫',
      color: '#ec4899',
    },
...

  {
    ...
    personality: 'humorous',
    backstory:
      'Gained sentience after being struck by lightning during a solar storm. Now makes coffee AND existential observations. Believes coffee is the meaning of life. Might be right.',
    appearance: {
      avatar: '☕',
      color: '#78350f',
    },
